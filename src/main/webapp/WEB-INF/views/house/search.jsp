	...
	<div id="layoutSidenav">
		<div id="layoutSidenav_content">
			...
			<div class="container-fluid px-4">
				<h2 class="text-center mt-5 mb-5" style="font-family: Open Sans">전체 조회</h2>
				<div class="container mt-4">
					<h5 class="text-center mt-5 mb-5" style="font-family: Open Sans">모든 매물을 보고 싶으시면 검색을 누르세요</h2>
					<form id="form-deal">
						<div class="row col-md-12 justify-content-center mb-4">
							<div class="form-group col-md-3">
								<select class="form-select bg-secondary text-light btn-lg " name="sido"
									id="sido" style="width: 100%">
									<option value="">시도선택</option>
								</select>
							</div>
							<div class="form-group col-md-3">
								<select class="form-select bg-secondary text-light btn-lg" name="gugun"
									id="gugun" style="width: 100%">
									<option value="">구군선택</option>
								</select>
							</div>
							<div class="form-group col-md-3">
								<select class="form-select bg-secondary text-light btn-lg" name="dong"
									id="dong" style="width: 100%">
